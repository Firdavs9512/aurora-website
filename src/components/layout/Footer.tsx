      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-purple-400 font-mono text-xl font-bold">Aurora</span>
          ...
          <div>
            <h3 className="text-lg font-mono font-bold mb-4">Product</h3>
          ...
          <div>
            <h3 className="text-lg font-mono font-bold mb-4">Resources</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-mono font-bold mb-4">Company</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} Aurora Terminal Agent. All rights reserved.
          </p>
